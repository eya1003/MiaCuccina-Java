...
public class StatRecController implements Initializable {
    ...
    private List<Evenement> listRec = new ArrayList<>();
    ...
    private void btnPDFClicked(MouseEvent event) throws FileNotFoundException, DocumentException, IOException{
                saveAsPng(bc, "C:\\Users\\eyaam\\Downloads\\MiaCuccina-Java-integration_event\\src\\img\\chart.png");

        OutputStream file = new FileOutputStream(new File("C:\\Users\\eyaam\\Downloads\\MiaCuccina-Java-integration_event\\TestPDF.pdf"));


            Document document = new Document();
            
            //document.setMargins(100,600,100,0);
            ...
            document.add(new Paragraph("Evenements: Stats"));

            document.add(new Paragraph(new Date().toString()));
            Image img = Image.getInstance("C:\\Users\\eyaam\\Downloads\\MiaCuccina-Java-integration_event\\src\\img\\chart.png");
            document.add(img);
            ...
            Notifications n = Notifications.create()
                              .title("PDF Chart")
                              .text("votre pdf a été enregistré")
    ...
    private void cbYearAction(ActionEvent event) {
        ...
        for (Evenement p : listRec) {
            System.out.println(""+p.getDate_event());
            int month = p.getDate_event().toLocalDate().getMonthValue() - 1;
            int year = p.getDate_event().toLocalDate().getYear();
