...
public class ListTablesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        table.add(new Table(rs.getInt("id_tab"),rs.getString("emp"),rs.getInt("nb_chaise_tab"),rs.getInt("stock_tab")));
            ...
            vueColl.setCellValueFactory(new PropertyValueFactory<Emplacement,String>("emp"));
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                     ...
                     btnsupp.setOnMouseClicked((MouseEvent event) -> {
                           ...
                           try{
                          T.deleteTable(TableList.getSelectionModel().getSelectedItem().getId_tab());
                                       
                                       
           JOptionPane.showMessageDialog(null, "Table supprimée");
           Table selectedItem = TableList.getSelectionModel().getSelectedItem();
            ...
            int index = TableList.getSelectionModel().getSelectedItem().getId_tab();
                            TableService T = new TableService();
           int stok = TableList.getSelectionModel().getSelectedItem().getStock_tab();
           int chaises = TableList.getSelectionModel().getSelectedItem().getNb_chaise_tab();
    ...
    @FXML
    private void getaddEmp(MouseEvent event) {
         try {
            Parent parent = FXMLLoader.load(getClass().getResource("/GUI/ListEmplacements.fxml"));
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
            stage.initStyle(StageStyle.UTILITY);
    ...
    @FXML
    private void reservationbtn(MouseEvent event) {
        try {
